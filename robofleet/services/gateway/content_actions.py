...
from robofleet.foundation.policy import communications as _comms
from robofleet.foundation.policy.content import ContentValidationError, markers
from robofleet.foundation.policy.content.validators import reject_trivial
from robofleet.foundation.policy.injection_guard import screen_external_text
from robofleet.foundation.policy.journaling import Scope as _Scope
from robofleet.models.base import TaskStatus
from robofleet.services.content_notes import content_type_for_role
...
from robofleet.services.gateway.commit_validator import validate_commit_message
...
from robofleet.services.x_client import MAX_TWEET_CHARS
...
if TYPE_CHECKING:
    ...
    from robofleet.foundation.policy.board_programs import BoardProgram
...
# table has been folded into `robofleet.foundation.policy.lifecycle`, but
...
# (robofleet.foundation.policy.board_programs.PROGRAMS), so a program registered
...
class ContentActions:
    ...
    async def draft_playbook(
        ...
        *,
        ...
        from robofleet.services.playbook import get_playbook_service
    ...
    async def pitch(
        ...
        *,
        ...
        from robofleet.models.pitch import PitchCreate
        from robofleet.services.base import ConflictError, ValidationError
        from robofleet.services.pitch import get_pitch_service
    ...
    async def notify(
        ...
        *,
        ...
        broadcasts).
        """
        from robofleet.models import NotificationPriority
    ...
    async def _reject_ceo_dependency_notify(
        ...
        """
        from robofleet.agents_config import is_ceo
    ...
    def _validate_per_call_extensions(
        ...
        """
        from robofleet.models.sandbox import SANDBOX_ENGINE_FEATURES
    ...
    async def request_sandbox(
        ...
        *,
        ...
        if rejection is not None:
            return rejection
        from robofleet.agents_config import _resolve_to_slug
