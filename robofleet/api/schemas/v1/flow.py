...
# acceptance criteria). Mirrors robofleet.foundation.policy.task_completeness
...
class IAmBlockedRequest(BaseModel):
    ...
    # 0c3d15a:robofleet/mcp/schemas/__init__.py required blocker_type and
...
class DelegateRequest(BaseModel):
    ...
    # robofleet/mcp/schemas/__init__.py::TaskCreateInput at 0c3d15a.
