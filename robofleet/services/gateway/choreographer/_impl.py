...
from robofleet.foundation.policy.batch import is_batch_root_subtask, is_batch_umbrella
...
from robofleet.services.gateway.choreographer._protocol import actor_context_fields
from robofleet.services.gateway.choreographer._verb_runner import VerbRunner
from robofleet.services.gateway.choreographer.collision import build_collision_context
from robofleet.services.gateway.choreographer.evidence_legs import (
    LegBudget,
    run_bounded_leg,
)
from robofleet.services.gateway.claim_guards import (
...
from robofleet.services.gateway.role_config import role_carries_notify_ack
...
class Choreographer:
    ...
    async def _check_tracing_gates(
        ...
        """
        from robofleet.config import settings as _settings
        from robofleet.foundation.policy import tracing as _tr
    ...
    async def _handle_rate_limited_parking(
        ...
        *,
        ...
        if provider != "unknown":
            try:
                from robofleet.services.gateway.rate_limit_tracker import (
    ...
    def _validate_assignee_task_type(assigned_to: str, task_type: str) -> str | None:
        ...
        if pm_err is not None:
            return pm_err
        from robofleet.foundation.identity import AGENTS, Role, Team
    ...
    def _pm_task_type_error(assigned_to: str, task_type: str) -> str | None:
        ...
        """
        from robofleet.foundation.identity import AGENTS, Role
    ...
    def _resolve_delegate_enums(inputs: DelegateInputs) -> tuple[Any, Any, Any]:
        ...
        """
        from robofleet.models.base import Complexity, TaskType, Team
    ...
    async def _wire_ux_frontend_dependency(self, new_task: Any, parent: Any) -> None:
        ...
        from robofleet.foundation.policy.batch import is_batch_root_subtask
    ...
    async def _notify_ceo_merge_conflict(
        ...
        from robofleet.services.notification import NotificationService
        from robofleet.services.notification_text import agent_display
