...
from robofleet.api.auth.routes import mount_cloud_auth
from robofleet.api.auth.seed import ensure_seed_user_startup
from robofleet.api.deps import _auth_required, get_orchestrator_or_none
from robofleet.api.middleware import setup_middleware
from robofleet.api.routes.a2a import router as a2a_router
from robofleet.api.routes.a2a import wellknown_router as a2a_wellknown_router
...
from robofleet.api.routes.cockpit import router as cockpit_router
from robofleet.api.routes.company_goals import router as company_goals_router
from robofleet.api.routes.coroner import router as coroner_router
...
from robofleet.api.routes.mirror import router as mirror_router
...
from robofleet.api.routes.periscope import router as periscope_router
from robofleet.api.routes.pest_control import router as pest_control_router
from robofleet.api.routes.pitch import router as pitch_router
from robofleet.api.routes.playbooks import router as playbooks_router
from robofleet.api.routes.product import router as product_router
...
from robofleet.api.routes.research import router as research_router
from robofleet.api.routes.roadmap import router as roadmap_router
from robofleet.api.routes.scales import router as scales_router
from robofleet.api.routes.secretary import router as secretary_router
from robofleet.api.routes.secretary_live import router as secretary_live_router
from robofleet.api.routes.sentinel import router as sentinel_router
from robofleet.api.routes.settings import router as settings_router
from robofleet.api.routes.spackle import router as spackle_router
...
from robofleet.api.routes.telegram import router as telegram_router
...
from robofleet.api.routes.v1 import flow_auditor as flow_auditor_module
from robofleet.api.routes.v1 import flow_board as flow_board_module
...
from robofleet.api.routes.v1 import flow_pr_reviewer as flow_pr_reviewer_module
...
from robofleet.api.routes.work_session import router as work_session_router
from robofleet.api.routes.x import router as x_router
from robofleet.api.websocket import router as ws_router
from robofleet.config import settings
from robofleet.db.base import close_db, get_session_factory, init_db
from robofleet.logging import get_logger, setup_logging
from robofleet.security import apply_guard, guarded_lifespan
...
from robofleet.services.optimal import close_optimal_service, get_optimal_service
from robofleet.services.playbook import PlaybookService
from robofleet.services.rag_index_failures import (
    backfill_unindexed_journals,
    reclaim_due,
)
from robofleet.services.settings import apply_persisted_feature_flags
...
def create_app() -> FastAPI:
    ...
    # picker's installation/repository listing (see github_app_auth.py).
    app.include_router(
        github_app_router,
