...
from robofleet.enforcement import JournalAccessDeniedError, validate_journal_access
...
from robofleet.services.journal import ListEntriesFilter, get_journal_service
...
async def create_entry(
    ...
    if entry is None:
        raise HTTPException(
            ...
            detail=(
                "JOURNAL_ENTRY_SKIPPED: The referenced task or journal "
