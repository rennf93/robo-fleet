"""Shared vault-note text policy: RoboFleet's own feedback-callout convention,
...
RoboFleet callout stripped first, via this one shared pattern. Both also parse
...
# Matches any RoboFleet feedback callout (``> [!info] RoboFleet: drafted ...``,
# ``> [!warning] RoboFleet: quarantined ...``, ...) through end of line —
...
def content_hash(raw_text: str) -> str:
    """Sha256 of ``raw_text`` with every RoboFleet feedback callout stripped, so
