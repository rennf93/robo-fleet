...
Mirrors ``robofleet/api/routes/roadmap.py``'s CEO-gating shape. Lists every
registered program (``robofleet.foundation.policy.board_programs.PROGRAMS``)
...
from robofleet.api.utils.board_programs import cycle_to_response as _cycle_to_response
from robofleet.api.utils.board_programs import require_ceo as _require_ceo
from robofleet.api.utils.board_programs import to_response as _to_response
