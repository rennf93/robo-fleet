...
``robofleet.foundation.__init__`` can import the identity validators
without dragging the lifecycle spec into its import graph.

Every check below must pass before ``robofleet.foundation.policy.lifecycle``
...
Imports of ``robofleet.foundation.policy.lifecycle`` are deliberately
...
def _check_status_enum_coverage() -> None:
    ...
    (b) every source/target referenced in _STATUS_TRANSITIONS is a real Status
        ...
        caught.
    """
    from robofleet.foundation.policy.lifecycle import _STATUS_TRANSITIONS, Status
...
def _check_intent_compositions() -> None:
    ...
    check in that case.
    """
    from robofleet.foundation.policy.lifecycle import _ATOMIC_ACTIONS, _INTENT_VERBS
...
def _check_claim_rules_role_coverage() -> None:
    ...
    from robofleet.foundation.policy.lifecycle import CLAIM_RULES, Role
...
def _check_claim_rules_status_coverage() -> None:
    ...
    from robofleet.foundation.policy.lifecycle import CLAIM_RULES, Status
...
def _check_self_review_symmetry() -> None:
    ...
    """
    from robofleet.foundation.policy.lifecycle import _ATOMIC_ACTIONS
...
def _check_role_team_rules_slugs() -> None:
    ...
    from robofleet.foundation.policy.lifecycle import ROLE_TEAM_RULES
...
def _check_action_target_reachable_from_source() -> None:
    ...
    """
    from robofleet.foundation.policy.lifecycle import _ATOMIC_ACTIONS, STATUS_GRAPH
...
def _check_role_team_rules_team_match() -> None:
    ...
    """
    from robofleet.foundation.policy.lifecycle import ROLE_TEAM_RULES
    from robofleet.seeds.initial_data import DEFAULT_AGENTS
...
def run_all_lifecycle_validators() -> None:
    ...
    Called from ``robofleet.foundation.policy.lifecycle`` at module-load
