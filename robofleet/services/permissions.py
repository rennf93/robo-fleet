...
from robofleet.foundation.identity import PM_ROLES
from robofleet.foundation.identity import Role as _FoundationRole
from robofleet.foundation.policy.communications import NOTIFY_SENDER_ROLES
...
from robofleet.services.base import SingletonService

# PM_ROLES is canonical in foundation.identity; re-exported here for
# backwards compatibility with existing `from robofleet.services.permissions
...
# and TaskAction are re-exported from robofleet.models.permissions, and
