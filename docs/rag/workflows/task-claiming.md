...
Read your claim briefing (`context_briefing`, returned inline). There is no separate proactive-context or KB-search tool to call under this runtime  -  see `docs/rag/workflows/kb-search.md`.
