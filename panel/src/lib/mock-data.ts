...
- Add rate limiting on auth endpoints`,
    ...
    project_id: PROJECT_IDS.robofleet,
    docs_complete: false,
    pr_created: false,
    pm_approvals: {},
    acceptance_criteria: [
...
- First task creation`,
    ...
    project_id: PROJECT_IDS.robofleetPanel,
    docs_complete: false,
    pr_created: false,
    pm_approvals: {},
    acceptance_criteria: [
    ...
    pr_number: 42,
    pr_url: "https://github.com/robofleet/robofleet/pull/42",
    plan: {
      approach:
...
- Example requests`,
    ...
    pr_number: 38,
    pr_url: "https://github.com/robofleet/robofleet/pull/38",
    plan: null,
    progress_updates: [],
    checkpoints: [],
    commits: [
