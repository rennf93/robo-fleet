...
Route-glue helpers backing robofleet/api/routes/optimal.py.
"""

from fastapi import status
from fastapi.responses import JSONResponse

from robofleet.api.deps import CurrentAgentContext, PermissionServiceDep
from robofleet.services.gateway.kb_authz import authorize_kb_action
