...
Mirrors ``robofleet.services.roadmap_engine.RoadmapEngine``'s "detect -> originate
...
from robofleet.services.board_programs import (
...
class PestControlEngine(BaseService):
    ...
    async def _pick_rotation_target(self, projects: list[ProjectTable]) -> ProjectTable:
        ...
        ``robofleet.services.board_programs.pick_rotation_target`` (shared by
