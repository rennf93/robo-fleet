"""CLI entrypoint for the eval bench.
    ...
    python -m robofleet.eval run --role <slug> --cohort <name> \\
...
from robofleet.eval.runner import EvalRunner


def _parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(prog="python -m robofleet.eval")
