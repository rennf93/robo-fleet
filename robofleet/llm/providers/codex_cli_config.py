...
unit-testable, mirroring :mod:`robofleet.llm.providers.grok_cli_config`.
...
# robofleet.runtime.orchestrator._generate_mcp_config's UV_PROJECT_ENVIRONMENT
...
# Deny parity with grok's --deny rules (robofleet/llm/providers/grok_cli_config's
...
def render_execpolicy_rules() -> str:
    ...
    """
    lines = [
        "# Generated by robofleet.llm.providers.codex_cli_config — do not hand-edit.",
