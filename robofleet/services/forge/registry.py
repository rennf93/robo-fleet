...
:class:`~robofleet.services.forge.router.ForgeRouter` consults per call:
...
from robofleet.foundation.policy.forge import extract_host
...
if TYPE_CHECKING:
    from robofleet.services.forge.base import GitProvider
...
def provider_for(project: Any | None = None) -> GitProvider:
    ...
    ``robofleet.foundation.policy.forge.detect_provider``'s default.
    """
    provider_name = (
