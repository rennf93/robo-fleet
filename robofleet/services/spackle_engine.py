...
Mirrors ``robofleet.services.pest_control_engine.PestControlEngine``'s "detect ->
...
from robofleet.services.task import SPACKLE_SOURCE, TaskCreateRequest, get_task_service
