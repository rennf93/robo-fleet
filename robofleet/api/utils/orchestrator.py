...
Route-glue helpers backing robofleet/api/routes/orchestrator.py.
"""
...
from robofleet.agents_config import CEO_AGENT_ID, _resolve_to_slug, verify_agent_token
from robofleet.api.auth.backend import SESSION_COOKIE_NAME
from robofleet.api.auth.session import resolve_session_user
from robofleet.api.deps import _check_agent_auth_token, get_db, require_ceo_role
