...
:func:`robofleet.billing.pricing.calculate_cost`'s four-bucket formula instead of
...
The agent entrypoint runs ``python -m robofleet.llm.providers.codex_cli_usage``
