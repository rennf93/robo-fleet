...
def test_success_path_persists_telemetry() -> None:
    ...
    with patch(
        "robofleet.api.middleware._persist_verb_latency",
...
async def test_persist_verb_latency_swallows_db_failure() -> None:
    ...
    with patch(
        "robofleet.api.middleware.get_session_factory",
...
async def test_persist_verb_latency_swallows_commit_failure() -> None:
    ...
    with patch("robofleet.api.middleware.get_session_factory", return_value=_factory):
