...
from robofleet.api.routes.v1._role_dep import envelope_to_response, require_cell_pm
...
from robofleet.services.gateway.choreographer import Choreographer, DelegateInputs
...
async def submit_up(
    ...
    env = await choreographer.submit_up(
        x_agent_id,
        body.task_id,
        body.notes,
