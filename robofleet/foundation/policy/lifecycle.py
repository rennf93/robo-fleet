...
# Role enum is canonicalized in robofleet/foundation/identity.py.
...
# from `robofleet.foundation.identity` directly.
from robofleet.foundation.identity import Role, Team
...
ROLE_TEAM_RULES: dict[str, str | None] = {
    ...
    # Shared cell-gate overflow reviewer - serves all cells (team BOARD).
    "cell-pr-reviewer-2": None,
    "ceo": None,
}
...
# validators themselves live in ``robofleet.foundation._validate_lifecycle``
...
# ``robofleet.foundation.__init__`` eagerly imports ``foundation/_validate``.
from robofleet.foundation._validate_lifecycle import (  # noqa: E402
