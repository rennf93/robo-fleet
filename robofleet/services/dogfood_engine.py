...
Mirrors ``robofleet.services.spackle_engine.SpackleEngine``'s "detect ->
...
``robofleet.services.board_programs._ORIGINATORS`` (Coroner's entry there is a
...
from robofleet.services.task import DOGFOOD_SOURCE, TaskCreateRequest, get_task_service
