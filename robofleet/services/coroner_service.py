...
payload — see
``robofleet.foundation.policy.content.markers.get_coroner_postmortem``), which
...
items (``robofleet.services.coroner_engine``'s own docstring: "a postmortem is
...
from robofleet.services.task import CORONER_ITEM_SOURCE, CORONER_SOURCE
