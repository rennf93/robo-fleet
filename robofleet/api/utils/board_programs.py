...
Route-glue helpers backing robofleet/api/routes/board_programs.py.
"""
...
if TYPE_CHECKING:
    from robofleet.api.routes.board_programs import (
...
async def to_response(engine: BoardProgramEngine, key: str) -> "BoardProgramResponse":
    ...
    # this module.
    from robofleet.api.routes.board_programs import BoardProgramResponse
