...
from robofleet.utils.converters import require_uuid, to_python_uuid
...
class JournalService(BaseService):
    ...
    async def resolve_agent_id(self, agent_id_or_slug: str) -> UUID | None:
        ...
        """
        from robofleet.services.repositories import resolve_agent_uuid
    ...
    async def get_agent_slug(self, agent_id: UUID) -> str | None:
        ...
        """
        from robofleet.services.repositories import get_agent_slug
    ...
    async def search_entries(
        ...
        try:
            optimal = await self._get_optimal_service()
            from robofleet.services.optimal import IndexType, QueryContext
