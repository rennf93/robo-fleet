...
from robofleet.foundation.identity import CELL_TEAMS
...
from robofleet.foundation.policy.sequencing.models import DraftSurface, SequencePlan
...
class PrompterService:
    ...
    def _sequence_drafts(self, drafts: list[dict[str, Any]]) -> SequencePlan:
        ...
        """
        from robofleet.foundation.policy.sequencing.models import SequencingError
        from robofleet.services.sequencing import SequencingService
...
def _scope_signature(
    ...
    ``robofleet.foundation.policy.batch``'s predicates) since callers pass either
