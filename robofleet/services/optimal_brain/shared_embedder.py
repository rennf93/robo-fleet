...
if TYPE_CHECKING:
    from robofleet.services.optimal_brain.ollama_embedder import OllamaEmbedder
...
async def get_shared_embedder(
    ...
    Returns:
        Shared :class:`~robofleet.services.optimal_brain.ollama_embedder.OllamaEmbedder`
        instance.
