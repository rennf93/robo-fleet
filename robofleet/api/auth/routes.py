...
cloud_auth_enabled, mirroring robofleet.security.apply_guard's conditional
...
from robofleet.api.auth.backend import SESSION_COOKIE_NAME, auth_backend
from robofleet.api.auth.login_limit import LoginRateLimiter
from robofleet.api.auth.manager import get_user_manager
