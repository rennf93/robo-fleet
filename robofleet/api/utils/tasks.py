...
Route-glue helpers backing robofleet/api/routes/tasks.py.
"""
...
def _task_is_awaiting_pm_review(task: Any) -> bool:
    ...
    from robofleet.models.base import TaskStatus as _TS
...
def _reassert_batch_shape(task: Any) -> None:
    ...
    from robofleet.services.task import TaskService as _TaskService
...
async def _resolve_assigned_to_slug(
    ...
    *data* unchanged.  If it is an agent slug, looks up the agent and replaces
    ...
    try:
        ...
        pass
    from robofleet.services.repositories.query_helpers import get_agent_by_slug
