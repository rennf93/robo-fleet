...
Route-glue helpers backing robofleet/api/routes/git.py.
"""
...
from robofleet.exceptions import GitCommandError, GitError, GitTimeoutError
...
# single, low-complexity dispatch (mirrors robofleet/api/utils/pitch.py's
# _SERVICE_ERROR_HTTP).
...
async def _resolve_project_slug(identifier: str, db: AsyncSession) -> str:
    ...
    "robo-fleet" or a UUID like "3fa85f64-5717-4562-b3fc-2c963f66afa6".
