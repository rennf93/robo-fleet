...
from robofleet.agents_config import CEO_AGENT_ID, verify_agent_token
from robofleet.api.auth.backend import (
    SESSION_COOKIE_NAME,
    cookie_transport,
    get_jwt_strategy,
)
from robofleet.api.auth.session import resolve_session_user
from robofleet.api.schemas.optimal import PaginationParams
from robofleet.config import settings
from robofleet.db.base import get_db, get_db_committed
from robofleet.db.tables import AgentTable, UserTable
from robofleet.foundation.identity import BOARD_ROLES, DEV_ROLES, PM_ROLES, Role
from robofleet.models import AgentRole, Team
from robofleet.runtime import AgentOrchestrator
...
from robofleet.services.permissions import AgentContext, PermissionService
from robofleet.services.product import ProductService
from robofleet.services.repositories import resolve_agent_identity, resolve_agent_uuid
...
# response reaches the client (see robofleet/db/base.py, robofleet/api/middleware.py).
...
async def get_choreographer(
    ...
    from robofleet.events.stream_bus import get_stream_event_bus
