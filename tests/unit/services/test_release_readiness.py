...
# --------------------------------------------------------------------------- #
# project_version: manifest-variant probing, never raises on a non-Python
...
def test_project_version_falls_back_to_package_json(tmp_path: Path) -> None:
    ...
    assert project_version(tmp_path) == "4.5.6"
