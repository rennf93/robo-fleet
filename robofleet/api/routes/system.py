...
from robofleet.api.deps import require_panel_token
from robofleet.api.schemas.system import RateLimitEntry, RateLimitListResponse
from robofleet.api.utils.system import _resume_at
...
async def get_rate_limits() -> RateLimitListResponse:
    ...
    Backed by
    :class:`~robofleet.services.gateway.rate_limit_tracker.RateLimitStateTracker`.
