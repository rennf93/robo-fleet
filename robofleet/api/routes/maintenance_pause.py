...
stack. See ``robofleet.services.maintenance_pause`` for the mechanism and
``robofleet.runtime.orchestrator``'s gate call sites for where each scope is
actually consulted. Mirrors ``robofleet/api/routes/board_programs.py``'s
CEO-gating shape.
"""
